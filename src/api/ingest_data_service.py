...
from src.utils.html_type_ingestion_preprocess import (NodeFileNameToURL)
...
class IngestionService:
    ...
    def initialize_ingestion_pipeline(self):
        ...
        pipeline = IngestionPipeline(
            ...
            docstore=RedisDocumentStore.from_host_and_port(host, port, namespace="document_store"),
    ...
    def insert(self, doc_file_path):
        ...
        # insert progress
        self.ingestion_pipeline.run(documents=documents, in_place=True, show_progress=True)
